  ...
  (function () {
    ...
    startButton.on("click", function (event) {
      ...
      kick.animate({
        ...
        complete: function () {
          kick.html("<img src='img/kick_smile.png' alt='mr kick' />");
          kick.animate({
            top: "370px"
          }, {
            duration: 500,
            ...
            complete: function () {
              ...
              box1.delay(500).queue(function (n) {
                $(this).html("<img src='img/box_c.png' alt='box 1' />");
                if (ans == 1) kick.hide();
                n();
              });
              box2.delay(1000).queue(function (n) {
                $(this).html("<img src='img/box_c.png' alt='box 2' />");
                if (ans == 2) kick.hide();
                n();
              });
              box3.delay(1500).queue(function (n) {
                $(this).html("<img src='img/box_c.png' alt='box 3' />");
                if (ans == 3) kick.hide();
                ...
                setTimeout(function () {
                  ...
                  setMessage("Click on the box, that you think Mr Kick is hidden")

                  box1.click(function () {
                    if (flag == 0) {
                      $(this).html('<img src="img/box_o_t.png" id="box_o_t" alt="box top 1">');
                      $(this).append(' <img src="img/box_o_b.png" id="box_o_b" alt="box bottom 1">');
                      if (ans == 1) {
                        kick.css({
                  ...
                  box2.click(function () {
                    if (flag == 0) {
                      $(this).html('<img src="img/box_o_t.png" id="box_o_t" alt="box top 2">');
                      $(this).append(' <img src="img/box_o_b.png" id="box_o_b" alt="box bottom 2">');
                      if (ans == 2) {
                        kick.css({
                          left: $(this).position().left + 46 + "px"
                        });
                  ...
                  $("#box3").click(function () {
                    if (flag == 0) {
                      $(this).html('<img src="img/box_o_t.png" id="box_o_t" alt="box top 3">');
                      $(this).append(' <img src="img/box_o_b.png" id="box_o_b" alt="box bottom 3">');
                      if (ans == 3) {
                        kick.css({
                          left: $(this).position().left + 46 + "px"
                        });
                  ...
                  function print_error() {
                    setMessage("Nothing found.. :P <a href='index.html' >try again</a>", "color_1");
                  }
